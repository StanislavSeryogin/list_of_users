...
/*
Вибачте, я вже не маю часу на рефакторинг коду та написання тестів. Цей тест писався до додавання supportData, потрібно буде переписати клас UserRepository і створити два власні класи, для UserRepository та SupportRepository.
 */
...
//         // arrange
//         when(
//           () => mockHTTPClient.get(Uri.parse(kUsersURL)),
